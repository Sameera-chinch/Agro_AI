    ...
    <div className="pe" style={{padding:"2rem",maxWidth:1200,margin:"0 auto"}}>
      ...
      <div className="card" style={{padding:"1.45rem",overflow:"auto"}}>
        ...
        <table style={{width:"100%",borderCollapse:"collapse",fontSize:".85rem",fontFamily:"'Outfit',sans-serif"}}>
          ...
          <tbody>
            {fields.map(f=>(
              <tr key={f._id} className="row" onClick={()=>setFieldModal(f)} style={{borderBottom:"1px solid rgba(255,255,255,.04)",cursor:"pointer",transition:"background .2s"}}>
                <td style={{padding:".75rem .65rem",fontWeight:600,color:"#fff"}}>{f.fieldName}</td>
